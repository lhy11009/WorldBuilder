...
#ifndef WORLD_BUILDER_FEATURES_OCEANIC_PLATE_MODELS_INDICATOR_UNIFORM_H
#define WORLD_BUILDER_FEATURES_OCEANIC_PLATE_MODELS_INDICATOR_UNIFORM_H
    ...
    namespace OceanicPlateModels
    {
      namespace Indicator
      {
        ...
        class Uniform final: public Interface
        {
          ...
          private:
            // uniform indicator submodule parameters
            double min_depth;
