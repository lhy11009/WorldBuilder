...
{ 
  ...
  // Query point 1, the nearest point on the ridge is in the middle of p1a nd p1b
  ...
  // Query point 2, the nearest point on the ridge is in the middle of p2b nd p2c
